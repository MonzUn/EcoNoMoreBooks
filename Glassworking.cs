...
namespace Eco.Mods.TechTree
{
    ...
    public partial class GlassworkingSkillScrollRecipe : RecipeFamily
    {
 ...
 new IngredientElement("Basic Research", 10),  
            ...
            this.Initialize(Localizer.DoStr("Glassworking Skill Scroll"), typeof(GlassworkingSkillScrollRecipe));
