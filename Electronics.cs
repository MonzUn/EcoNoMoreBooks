...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ElectronicsSkillScrollRecipe : RecipeFamily
    {
 ...
 new IngredientElement("Modern Research", 20),  
            ...
            this.Initialize(Localizer.DoStr("Electronics Skill Scroll"), typeof(ElectronicsSkillScrollRecipe));
